 ...
 *
 * <p>Several implementations are thin adapters over detectors that already existed elsewhere in the
 * codebase. That is deliberate: this feature needs the same Double Bottom that the bullish ranking
 * uses, and a second implementation of it would be two sources of truth for one question.
 */
